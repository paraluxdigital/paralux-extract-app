...
export const Hero: React.FC<HeroProps> = ({ onOpenPortal, onViewPricing }) => {
  return (
    <section className="relative pt-32 pb-20 border-b border-[#4a5568]/60 bg-[#1a202c]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#dd6b20]/15 border border-[#dd6b20]/30 text-[#dd6b20] text-xs font-semibold uppercase tracking-wider mb-6 shadow-sm">
          ...
          <span>Paralux Digital Document AI Engine</span>
        </div>
        ...
        <p className="text-base sm:text-lg text-[#a0aec0] max-w-2xl mx-auto font-normal leading-relaxed mb-10">
          Extract validated, typed JSON data from PDF invoices, scanned receipts, medical summaries, and contracts with high-speed automated intelligence. Plans starting at <strong className="text-[#f7fafc] font-semibold">$20/mo for 1,000 document credits</strong>.
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto text-left">
          ...
          <div className="bg-[#2d3748] p-4 rounded-xl border border-[#4a5568] hover:border-[#dd6b20] transition-all flex items-center gap-3 group">
          ...
          <div className="bg-[#2d3748] p-4 rounded-xl border border-[#dd6b20]/60 hover:border-[#dd6b20] transition-all flex items-center gap-3 group">
